...
const AddFundingSource = ({ onComplete }: AddFundingSourceProps) => {
  ...
  const handleTinkClick = () => {
    ...
    // Using the deep link scheme for the callback URL
    const callbackUrl = encodeURIComponent('fingerpay://callback');
    window.location.href = `https://link.tink.com/1.0/pay/vrp-mandate?client_id=e5ca99078f154a58854f5505aebfc6ac&consent_id=2dcd7ccb-5bd1-463d-94e7-6f19bd6b0df4&authorization_code=b63ddb4e3a0047c59f1b9484cf19a850&redirect_url=${callbackUrl}`;
  };
